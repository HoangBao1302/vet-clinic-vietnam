...
export default function EditFeaturedAccountPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        alert('Featured account updated successfully!');
        router.push('/admin/content-dashboard');
      } else {
        const data = await response.json();
          ...
          <div className="container-custom max-w-4xl">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="bg-gradient-to-r from-yellow-600 to-orange-600 text-white p-8">
                ...
                <h1 className="text-3xl font-bold">Edit Featured Account</h1>
                <p className="text-yellow-100 mt-2">Update featured account information</p>
              </div>
