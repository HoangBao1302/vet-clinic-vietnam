...
const FOREX_RELEVANCE_PATTERN = /\b(forex|fx\b|currenc(?:y|ies)|exchange rate|eur\/usd|eurusd|gbp\/usd|gbpusd|usd\/jpy|usdjpy|usd\/cad|usdcad|aud\/usd|audusd|nzd\/usd|nzdusd|usd\/chf|usdchf|xau\/usd|xauusd|gold trading|gold price|central bank|federal reserve|\bfed\b|\becb\b|\bboj\b|\bboe\b|\brba\b|interest rate|pip(?:s)?|carry trade|dollar index|\bdxy\b|foreign exchange|emerging market(?:s)? currenc)\b/i;
