...
const FOREX_RELEVANCE_PATTERN = /\b(forex|fx\b|currency|currencies|eur\/usd|gbp\/usd|usd\/jpy|dollar|euro|yen|pound|exchange rate|central bank|fed\b|ecb\b|boj\b|boe\b|gold|xau|oil|crude|commodit|foreign exchange|cpi\b|inflation|interest rate|monetary policy|trade war|tariff)\b/i;
