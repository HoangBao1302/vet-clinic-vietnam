...
const FOREX_KEYWORDS = /\b(forex|fx\b|currency|currencies|eur\/usd|gbp\/usd|usd\/jpy|usd\/cad|aud\/usd|dollar|euro|yen|pound|sterling|gold|silver|crude|oil|fed\b|ecb|boj|interest rate|exchange rate|central bank|cpi|inflation|treasury|yen|swiss franc)\b/i;
...
function isForexRelevant(article) {
  ...
  return FOREX_KEYWORDS.test(text);
}
