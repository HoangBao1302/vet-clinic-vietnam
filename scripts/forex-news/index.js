...
const FOREX_KEYWORDS = /\b(forex|fx\b|currenc(?:y|ies)|eur\/usd|usd\/jpy|gbp\/usd|exchange rate|central bank|interest rate|gold trading|commodit(?:y|ies)|pip\b|carry trade|dollar|euro|yen|pound sterling|swiss franc)\b/i;
