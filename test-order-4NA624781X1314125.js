// Test PayPal order 4NA624781X1314125 với different productIds
const orderId = "4NA624781X1314125";

// Test với các productId có thể từ frontend
const possibleProductIds = [
  "ea-full-mt5",      // MT5 Full Version (most likely)
...
async function testOrderVerification() {
  ...
  for (const productId of possibleProductIds) {
